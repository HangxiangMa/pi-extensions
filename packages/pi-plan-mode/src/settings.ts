...
export function normalizePlanModeSettings(value: unknown): PlanModeSettings | undefined {
  ...
  if (Object.hasOwn(value, "deferredToolLoading")) {
    ...
    if (!DEFERRED_TOOL_LOADING_MODES.includes(deferredToolLoading as DeferredToolLoadingMode)) return undefined;
...
export function updatePlanModeSettings(
  ...
  return enqueueMutation(settingsPath, async () => {
    ...
    if (patch.deferredToolLoading !== undefined) updated.deferredToolLoading = patch.deferredToolLoading;
